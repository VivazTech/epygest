...
export function getSearchPlaceholder(activeTab: string): string {
  ...
  if (activeTab === 'rel-crd' || activeTab.startsWith('rel-crd-')) return 'Buscar conta, código ou valor...';
  ...
  const map: Record<string, string> = {
    ...
    notas: 'Buscar protocolo, nota, fornecedor, setor ou CRD...',
    danfe: 'Buscar protocolo, DANFE, fornecedor, setor ou CRD...',
    requisicoes: 'Buscar protocolo, requisição, fornecedor ou CRD...',
    'lancamentos-manuais': 'Buscar protocolo, lançamento, fornecedor, setor ou CRD...',
    estornos: 'Buscar protocolo, estorno, fornecedor, setor ou CRD...',
    comandas: 'Buscar protocolo, comanda, fornecedor, consumidor ou local...',
