...
export const PLANILHAS: PlanilhaMeta[] = [
  ...
  { indice: 5, nome: 'Cópia de Orçamento 2026', arquivo: 'aba_005_C_pia_de_Or_amento_2026.json' },
  { indice: 6, nome: 'Calculos', arquivo: 'aba_006_Calculos.json' },
  { indice: 7, nome: 'RELATÓRIO CRD', arquivo: 'aba_007_RELAT_RIO_CRD_.json' },
  { indice: 8, nome: 'Informações importantes', arquivo: 'aba_008_Informa__es_importantes.json' },
  { indice: 9, nome: 'APURAÇÃO', arquivo: 'aba_009_APURA__O.json' },
  { indice: 10, nome: 'ORGANIZAÇÃO P/ BAIXA', arquivo: 'aba_010_ORGANIZA__O_P__BAIXA.json' },
  { indice: 11, nome: 'Relatório Requisições', arquivo: 'aba_011_Relat_rio_Requisi__es.json' },
